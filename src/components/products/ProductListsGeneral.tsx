...
import ArrivalProductList from './ArrivalList'
...
export default function ProductListsGeneral() {
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
           ...
           <h5 className='lily-script-one-regular'>Our Products</h5>
            <h1 className="text-4xl font-extrabold text-[#6e832b] jost-bold">New Arrivals</h1>
           </div>
